...
/***********************************************************************************/
{
	...
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_THREADS, 1);
	...
	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPX_PARAM_NODESEL,CPX_NODESEL_DFS);
	if (RAMSEY_instance->status)
	{
		printf ("error for CPX_PARAM_MIPEMPHASIS\n");
	}
	...
	//
	//	RAMSEY_instance->status = CPXsetintparam (RAMSEY_instance->env_MODEL_1, CPXPARAM_MIP_Strategy_VariableSelect,CPX_VARSEL_DEFAULT);
	//			if (RAMSEY_instance->status)
	//			{
	//				printf ("error for CPX_PARAM_MIPEMPHASIS\n");
	//			}
